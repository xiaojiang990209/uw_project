    ...
    <FormWrapper>
      ...
      <Form onSubmit={onFormSubmit}>
        ...
        <StyledFormGroup row>
          ...
          <Col>
              <Input id="courseCode" placeholder="Course code" maxLength={3} required onChange={e => setSelectedCourse(e.target.value)}/>
          </Col>
        </StyledFormGroup>
        <StyledFormGroup row>
        ...
        <Button style={{ float: 'right' }} type="submit" color="success">Find me a group!</Button>
        {error && <div>{error}</div>}
      </Form>
    </FormWrapper>
  );
